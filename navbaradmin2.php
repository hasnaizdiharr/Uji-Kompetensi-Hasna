    ...
    <span class="brand-text">E-Kinerja</span>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <?php if($page == 'kinerjakaryawan.php') echo 'active'; ?>" href="kinerjakaryawan.php">Data Penilaian Kinerja</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if($page == 'datakaryawan.php') echo 'active'; ?>" href="datakaryawan.php">Data Karyawan</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link <?php if($page == 'admin2login.html') echo 'active'; ?>" href="#" onclick="logout(event)">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
